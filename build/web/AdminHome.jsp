...
<head>
    ...
    <link rel="icon" href="https://cdn.vectorstock.com/i/500p/40/26/capsule-pill-vector-30134026.jpg" type="image/x-icon">
    <style>
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> 
                ...
                <div class="nav_list"> 
                    <a href="AdminHome.jsp" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> 
