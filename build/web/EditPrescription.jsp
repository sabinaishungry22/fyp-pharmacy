...
<%@page import="com.Model.Prescription"%>
...
<!--                            <a href="#" class="nav_link"> <i class='bx bx-folder nav_icon'></i>
    ...
    <div class="height-100 bg-light">
        ...
        <%
            ...
            Prescription prescription = prescriptionDAO.selectPrescription(prescriptionId);
        %>
        ...
        <form action="PrescriptionController" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="patientName" name="patientName" value="<%= prescription.getPatientName() %>" required>
            </div>
            <div class="mb-3">
                <label for="doctorName" class="form-label">Doctor Name</label>
                <input type="text" class="form-control" id="doctorName" name="doctorName" value="<%= prescription.getDoctorName() %>" required>
            </div>
            <div class="mb-3">
                <label for="medicineName" class="form-label">Medicine Name</label>
                <input type="text" class="form-control" id="medicineName" name="medicineName" value="<%= prescription.getMedicineName() %>" required>
            </div>
            <div class="mb-3">
                <label for="dosage" class="form-label">Dosage</label>
                <input type="text" class="form-control" id="dosage" name="dosage" value="<%= prescription.getDosage() %>" required>
            </div>
            <div class="mb-3">
                <label for="quantity" class="form-label">Quantity</label>
                <input type="number" class="form-control" id="quantity" name="quantity" value="<%= prescription.getQuantity() %>" required>
            </div>
            <div class="mb-3">
                <label for="prescriptionDate" class="form-label">Prescription Date</label>
                <input type="date" class="form-control" id="prescriptionDate" name="prescriptionDate" value="<%= prescription.getPrescriptionDate() %>" required>
            </div>
            <div class="mb-3">
                <label for="notes" class="form-label">Notes</label>
                <textarea class="form-control" id="notes" name="notes"><%= prescription.getNotes() %></textarea>
            </div>
