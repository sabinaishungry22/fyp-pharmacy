...
<div class="container mt-5">
    ...
    <form action="TypeController?type=type" method="post">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="typeName" name="typeName" value="<%= type.getTypeName() %>" required>
        </div>
        <div class="form-group mb-3">
            <label for="status" class="form-label">Status</label>
            <select class="form-control" id="status" name="status" required>
                <option value="ACTIVE" <%= type.getStatus().equals("ACTIVE") ? "selected" : "" %>>Active</option>
                <option value="INACTIVE" <%= type.getStatus().equals("INACTIVE") ? "selected" : "" %>>Inactive</option>
            </select>
        </div>
