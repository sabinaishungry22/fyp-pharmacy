...
<!--                            <a href="#" class="nav_link"> <i class='bx bx-folder nav_icon'></i>
    ...
    try {
        ...
        suppliers = new ArrayList<>(); // Initialize with empty list in case of error
    }
%>
...
<div class="container mt-5">
    ...
    <form action="PurchaseController" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="boxPattern" name="boxPattern" required>
        </div>
        <div class="mb-3">
            <label for="boxQty" class="form-label">Box Quantity</label>
            <input type="number" class="form-control" id="boxQty" name="boxQty" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="supplierPrice" name="supplierPrice" required>
        </div>
        <!-- No need for totalPurchasePrice input as it will be calculated -->
