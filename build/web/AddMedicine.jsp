...
.bxs-capsule {
    ...
    try {
        ...
        categories = new ArrayList<>(); // Initialize with empty list in case of error
    }
...
<div class="container mt-5">
        ...
        <select class="form-control" id="categoryId" name="categoryId" required>
            <% if (categories != null) { %>
                <% for (Category category : categories) { %>
                    <option value="<%= category.getId() %>"><%= category.getCategory_name() %></option>
                <% } %>
            <% } else { %>
    ...
    <div class="mb-3">
        ...
        <select class="form-control" id="unitId" name="unitId" required>
            <% if (units != null) { %>
                <% for (Unit unit : units) { %>
                    <option value="<%= unit.getId() %>"><%= unit.getUnit_name() %></option>
                <% } %>
            <% } else { %>
