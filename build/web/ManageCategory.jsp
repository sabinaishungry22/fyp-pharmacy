...
<!--                    <a href="#" class="nav_link"> <i class='bx bx-chart nav_icon'></i> 
    ...
    <div class="height-100 bg-light">
        <h4>Category List</h4>
        <a href="AddCategory.jsp" class="addMedicine">
            <i class='bx bx-plus nav_icon' style="color: whitesmoke; font-size: 24px;"></i>
            <span style="color: #white; font-weight: bold;">Add Category</span>
        </a>
        ...
        <tbody>
            <% for (Category category : categories) { %>
                <tr>
                    ...
                    <td>
                        <a href="CategoryController?action=edit&id=<%= category.getId() %>" class="btn btn-warning">Update</a>
                        <a href="CategoryController?action=delete&id=<%= category.getId() %>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            <% } %>
        </tbody>
