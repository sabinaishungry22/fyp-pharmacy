...
<form action="UnitController?type=unit" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="unitName" name="unitName" value="<%= unit.getUnit_name() %>" required>
    </div>
    <div class="mb-3">
        <label for="status" class="form-label">Status</label>
        <select class="form-control" id="status" name="status" required>
            <option value="ACTIVE" <%= unit.getStatus().equals("ACTIVE") ? "selected" : "" %>>Active</option>
            <option value="INACTIVE" <%= unit.getStatus().equals("INACTIVE") ? "selected" : "" %>>Inactive</option>
        </select>
    </div>
