...
<!--                            <a href="#" class="nav_link"> <i class='bx bx-folder nav_icon'></i>
        ...
        <h4>Purchase List</h4>
        <a href="AddPurchase.jsp" class="addMedicine">
            <i class='bx bx-plus nav_icon' style="color: whitesmoke; font-size: 24px;"></i>
            <span style="color: #white; font-weight: bold;">Add New Purchase</span>
        </a>
        ...
        <tbody>
            <% for (Purchase purchase : purchases) { %>
                <tr>
                    ...
                    <td><%= supplierDAO.getSupplierById(purchase.getSupplierId()).getSupplierName() %></td>
                    <td><%= purchase.getBatchId() %></td>
                    <td><%= purchase.getExpiryDate() %></td>
                    <td><%= purchase.getStockQty() %></td>
                    <td><%= purchase.getBoxPattern() %></td>
                    <td><%= purchase.getBoxQty() %></td>
                    <td><%= purchase.getQuantity() %></td>
                    <td><%= purchase.getSupplierPrice() %></td>
                    <td><%= purchase.getTotalPurchasePrice() %></td>
                    <td>
                        <a href="PurchaseController?action=edit&id=<%= purchase.getId() %>" class="btn btn-warning">Update</a>
                        <a href="PurchaseController?action=delete&id=<%= purchase.getId() %>" class="btn btn-danger">Delete</a>
                        <a href="PurchaseController?action=generate&id=<%= purchase.getId() %>" class="btn btn-primary">Generate Receipt</a>
                    </td>
                </tr>
            <% } %>
        </tbody>
