    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> 
                ...
                <div class="nav_list"> 
                    <a href="HealthHome.jsp" class="nav_link"> <i class='bx bx-grid-alt nav_icon'></i> 
                        <span class="nav_name">Dashboard</span> 
                    </a>                    
                    
                    <a href="ManagePrescription.jsp" class="nav_link active"> <i class='bx bx-message-square-detail nav_icon'></i>
...
<!--                    <a href="#" class="nav_link"> <i class='bx bx-chart nav_icon'></i> 
    ...
    <a href="AddPrescription.jsp" class="addMedicine">
            <i class='bx bx-plus nav_icon' style="color: whitesmoke; font-size: 24px;"></i>
            <span style="color: #white; font-weight: bold;">Add Prescription</span>
        </a>
            ...
            <tbody>
                <% for (Prescription prescription : prescriptions) { %>
                    <tr>
                        ...
                        <td>
                            <a href="PrescriptionController?action=edit&id=<%= prescription.getId() %>" class="btn btn-warning">Edit</a>
                            <a href="PrescriptionController?action=delete&id=<%= prescription.getId() %>" class="btn btn-danger">Delete</a>
                            <a href="PrescriptionController?action=generate&id=<%= prescription.getId() %>" class="btn btn-primary">Generate Prescription</a>
                        </td>
                    </tr>
                <% } %>
            </tbody>
