...
<!--                    <a href="#" class="nav_link"> <i class='bx bx-chart nav_icon'></i> 
    ...
    <div class="height-100 bg-light">
        <h4>Type List</h4>
        <a href="AddType.jsp" class="addMedicine">
            <i class='bx bx-plus nav_icon' style="color: whitesmoke; font-size: 24px;"></i>
            <span style="color: #white; font-weight: bold;">Add Type</span>
        </a>
        ...
        <%
    TypeDao typeDAO = new TypeDao(); // Assuming TypeDao handles CRUD operations for Type
    ...
    <table class="table mt-5">
        ...
        <tbody>
            <% for (Type type : types) { %>
                <tr>
                    <td><%= type.getId() %></td>
                    <td><%= type.getType_name() %></td>
                    <td><%= type.getStatus() %></td>
                    <td>
                        <a href="TypeController?type=type&action=edit&id=<%= type.getId() %>" class="btn btn-warning">Update</a>
                        <a href="TypeController?type=type&action=delete&id=<%= type.getId() %>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            <% } %>
        </tbody>
