...
<html>
    ...
    <body id="body-pd">
                ...
                <div> 
                    ...
                    <div class="nav_list"> 
                        ...
                        <ul class="nav_submenu">
                            <li>
                                <a href="ManageCategory.jsp" class="nav_link">
                                    <i class='bx bx-category nav_icon'></i>
                                    <span class="nav_name">Category</span>
                                </a>
                            </li>
                            <li>
                                <a href="ManageUnit.jsp" class="nav_link">
                                    <i class='bx bx-category nav_icon'></i>
                                    <span class="nav_name">Unit</span>
                                </a>
                            </li>
                            <li>
                                <a href="ManageType.jsp" class="nav_link">
                                    <i class='bx bx-category nav_icon'></i>
                                    <span class="nav_name">Type</span>
                                </a>
                            </li>
                        </ul>
        ...
        <div class="height-100 bg-light">
            <h4>Medicine List</h4>
            <a href="AddMedicine.jsp" class="addMedicine">
                <i class='bx bx-plus nav_icon' style="color: whitesmoke; font-size: 24px;"></i>
                <span style="color: #white; font-weight: bold;">Add Medicine</span>
            </a>
            ...
            <%
                MedicineDao medicineDAO = new MedicineDao(); // Assume you have a MedicineDAO class to handle CRUD operations
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%= categoryDAO.getCategoryById(medicine.getCategoryId()).getCategory_name()%></td>
                            <td><%= unitDAO.getUnitById(medicine.getUnitId()).getUnit_name()%></td>
                            <td><%= typeDAO.getTypeById(medicine.getTypeId()).getType_name()%></td>
                            <td><%= medicine.getQuantity()%></td>
                            <td><%= medicine.getPrice()%></td>
                            <td><%= medicine.getExpiryDate()%></td>
                            <td>
                                <a href="MedicineController?action=edit&id=<%= medicine.getId()%>" class="btn btn-warning">Update</a>
                                <a href="MedicineController?action=delete&id=<%= medicine.getId()%>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        <% }%>
                    </tbody>
