...
<!--                    <a href="#" class="nav_link"> <i class='bx bx-chart nav_icon'></i> 
    ...
    <div class="height-100 bg-light">
        <h4>Unit List</h4>
        <a href="AddUnit.jsp" class="addMedicine">
            <i class='bx bx-plus nav_icon' style="color: whitesmoke; font-size: 24px;"></i>
            <span style="color: #white; font-weight: bold;">Add Unit</span>
        </a>
    ...
    <table class="table mt-5">
        ...
        <tbody>
            <% for (Unit unit : units) { %>
                <tr>
                    <td><%= unit.getId() %></td>
                    <td><%= unit.getUnit_name() %></td>
                    <td><%= unit.getStatus() %></td>
                    <td>
                        <a href="UnitController?type=unit&action=edit&id=<%= unit.getId() %>" class="btn btn-warning">Update</a>
                        <a href="UnitController?type=unit&action=delete&id=<%= unit.getId() %>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
            <% } %>
        </tbody>
